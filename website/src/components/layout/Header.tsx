      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ...
            : "bg-gradient-to-b from-[var(--color-bg)]/80 via-[var(--color-bg)]/30 to-transparent"
        }`}
      >
        <nav
        ...
        >
          ...
          <Link href="/" className="relative z-50" aria-label="Gozu Studio Home">
            <svg
              className="h-8 w-auto text-[var(--color-body)]"
          ...
          >
            <span
              className={`block h-[1px] w-6 bg-[var(--color-body)] transition-all duration-300 ${
